...
theorem power_monotone_of_nonneg (a b : ℝ) (c : ℝ) (h₁ : a ≤ b) (h₂ : 0 ≤ c) :
  c^a ≤ c^b := by
  sorry
lemma perimeterPositive (t:Triangle) (h : ¬Trivial t) : 0 < perimeter t := by
unfold perimeter
have j : t.b ≠ t.a := by
  unfold Trivial at h
  simp_all only [ne_eq]
...
--lemma subtriangle_in_ball (t: Triangle) (ht: ¬Trivial t) (f : ℂ → ℂ) (z : ℂ) (hn: ∀ n, z ∈ TriangularSet ( triangleSequence f t n) ) (p:ℝ) (hp : 0 < p):
